...
def bm25_result_to_vector(result, intents_dictionary):
    ...
    intents_dictionary_for_bm25 = {
        intent: key
        for key, intent in zip(intents_dictionary.keys(), intents_dictionary.values())
    }
...
def find_intents_bm25(index, sentence, es):
    ...
    for r in response["hits"]["hits"]:
        ...
        intent = {"intent": r["_source"]["intent"], "confidence": normalized_score}
